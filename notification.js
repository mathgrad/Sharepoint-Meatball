...
var notification = scripts.filter(function (script) {
  if (script.src.indexOf("notification.js") > -1) {
    return script;
  }
});
notification = notification[0].src;
var baseUrl = notification.substring(0, notification.indexOf("notification"));
var ims = {};
ims.sharepoint = {};
